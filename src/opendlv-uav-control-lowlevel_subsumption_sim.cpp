...
int32_t main(int32_t argc, char **argv) {
    ...
    struct constVarStruct{
        ...
        float dodge_dist_totune = dodge_dist_totune;  
    ...
    std::thread StaticObsDodgeTask([od4, &isTerminateThread,
        ...
        while( od4->isRunning() ){
            ...
            float dodge_dist_totune = dodge_dist_totune;  
            {
                ...
                safeDist_ratio = cur_constVarStruct.safeDist_ratio;
                dodge_dist_totune = cur_constVarStruct.dodge_dist_totune;
            }
    ...
    std::thread DynamicObsDodgeTask([od4, &isTerminateThread,
        ...
        while( od4->isRunning() ){
            ...
            float time_ToMove_ratio = 1.0f;
            {
                ...
                nTargetCount = cur_constVarStruct.nTargetCount;
                dodge_dist_totune = cur_constVarStruct.dodge_dist_totune;
                cur_distToMove_ratio = cur_constVarStruct.cur_distToMove_ratio;
                time_ToMove_ratio = cur_constVarStruct.time_ToMove_ratio;
            }
    ...
    std::thread TargetFindingTask([od4, &isTerminateThread,
        ...
        while( od4->isRunning() ){
            ...
            float time_ToTurn_ratio = 0.0f;
            {
                ...
                safe_endreach_LR_dist = cur_constVarStruct.safe_endreach_LR_dist;
                nTargetCount = cur_constVarStruct.nTargetCount;
                angTurn_targetFinding = cur_constVarStruct.angTurn_targetFinding;
                time_ToTurn_ratio = cur_constVarStruct.time_ToTurn_ratio;
            }
    ...
    std::thread FrontReachingTask([od4, &isTerminateThread,
        ...
        while( od4->isRunning() ){
            ...
            float time_ToMove_target_ratio = 1.0f;
            {
                ...
                safe_endreach_LR_dist = cur_constVarStruct.safe_endreach_LR_dist;
                nTargetCount = cur_constVarStruct.nTargetCount;
                cur_distToMove_goto_ratio = cur_constVarStruct.cur_distToMove_goto_ratio;
                time_ToMove_goto_ratio = cur_constVarStruct.time_ToMove_goto_ratio;
                cur_distToMove_target_ratio = cur_constVarStruct.cur_distToMove_target_ratio;
                time_ToMove_target_ratio = cur_constVarStruct.time_ToMove_target_ratio;
            }
    ...
    std::thread LookAroundTask([od4, &isTerminateThread,
        ...
        while( od4->isRunning() ){            
            ...
            float timer_lookAround = 2;
            {
                ...
                safeDist_ratio = cur_constVarStruct.safeDist_ratio;
                time_ToTurn_ratio = cur_constVarStruct.time_ToTurn_ratio;
                angTurn_lookAround = cur_constVarStruct.angTurn_lookAround;
                timer_lookAround = cur_constVarStruct.timer_lookAround;
            }
            ...
            auto lookAroundEndTime = std::chrono::high_resolution_clock::now(); 
            {
                ...
                angleFrontState_vec = cur_lookAroundStruct.angleFrontState_vec;
                cur_lookAroundState = cur_lookAroundStruct.cur_lookAroundState;
                cur_sortType = cur_lookAroundStruct.cur_sortType;
                ori_front = cur_lookAroundStruct.ori_front;
                nlookAroundCount = cur_lookAroundStruct.nlookAroundCount;
                LookAroundElapsed = cur_lookAroundStruct.LookAroundElapsed;
                lookAroundStartTime = cur_lookAroundStruct.lookAroundStartTime;
            ...
            if ( cur_lookAroundState.clearPathCheckStarted == false ){
                ...
                if ( std::abs( angleDifference( cur_lookAroundState.targetAngle, cur_state_yaw ) ) >= 5.0f / 180.0f * M_PI ){
                    ...
                    }  
                    {
                        ...
                        cur_lookAroundStruct.cur_lookAroundState.clearPathCheckStarted = cur_lookAroundState.clearPathCheckStarted;
                        cur_lookAroundStruct.cur_lookAroundState.startAngle = cur_lookAroundState.startAngle;
                        cur_lookAroundStruct.cur_lookAroundState.targetRangeXMax = cur_lookAroundState.targetRangeXMax;
                        cur_lookAroundStruct.cur_lookAroundState.targetRangeYMax = cur_lookAroundState.targetRangeYMax;
                        cur_lookAroundStruct.cur_lookAroundState.targetRangeXMin = cur_lookAroundState.targetRangeXMin;
                        cur_lookAroundStruct.cur_lookAroundState.targetRangeYMin = cur_lookAroundState.targetRangeYMin;
                        cur_lookAroundStruct.cur_lookAroundState.nRangeTimer = cur_lookAroundState.nRangeTimer;
